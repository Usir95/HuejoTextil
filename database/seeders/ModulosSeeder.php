...
class ModulosSeeder extends Seeder {
    ...
    public function run(): void {
        ...
        $modulos = [
            ...
            [
                'nombre' => 'Entradas Almacen',
                'ruta' => 'Entradas.index',
                'descripcion' => 'Entradas de productos',
            ...
            [
                'nombre' => 'ProductosTerminados',
                'ruta' => 'ProductosTerminados.index',
                'descripcion' => 'Inventario de productos terminados',
            ...
            [
                'nombre' => 'Impresion Entradas',
                'ruta' => 'ReporteEntradas.index',
                'descripcion' => 'Reporte de Entradas de productos',
