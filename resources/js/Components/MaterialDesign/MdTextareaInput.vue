<template>
    <div class="relative w-full my-3 px-1" data-md-input="true" ref="rootRef">
        ...
        <textarea
            ...
            ref="inputRef"
            rows="4"
            class="w-full border rounded-xl text-gray-800 dark:text-gray-100 placeholder-white focus:outline-none focus:ring-2 transition-all duration-300 ease-in-out shadow-sm focus:shadow-md resize-none"
            :class="{
...
function updateValue(val) {
    let finalValue = props.uppercase ? val.toUpperCase() : val
